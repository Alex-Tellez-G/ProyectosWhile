...
while(true)
{
    let dato = prompt("Ejercicio 4: Por favor ingresar letras o palabras:");
    if(dato == "")
    {
        break;
    }
...
console.log("Ejercicio 4: \n La concatenación de todas las palabras es: " + resultado);
...
while(true)
{
    let dato1 = prompt("Ejercicio 5: Por favor ingresar un día de la semana (ej: lunes, jueves, domingo, etc):");
    if(dato1 == "DOMINGO")
    {
